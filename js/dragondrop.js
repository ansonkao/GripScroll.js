var DragonDrop = (function(){
  ...
  // @dropHandler   Takes a mouseup   event argument + data argument, Performs some action during the drop event
  var addHandler = function( target, dragHandler, dropHandler )
    {
